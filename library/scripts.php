...
function p_scripts() {
	wp_enqueue_script( 'p-main-js', get_stylesheet_directory_uri().'/js/main.js?v=10', array( 'jquery' ), false, true );
  wp_enqueue_script( 'p-mobile-detect', 'https://cdnjs.cloudflare.com/ajax/libs/mobile-detect/1.4.4/mobile-detect.min.js' );
}
